export const RetailsErrorCode = {
  ...
  "20000":
    "Catalog Item cannot be displayed as it does not meet statutory requirements",
  ...
  "30004":
    "When Seller App is unable to find the item id sent by the Buyer App",
  "30005":
    "When Seller App is unable to find the category id sent by the Buyer App",
  "30006":
    "When Seller App is unable to find the offer id sent by the Buyer App",
  "30007":
    "When the Seller App is unable to find the add-on id sent by the Buyer App",
  ...
  "30012":
    "When the Seller App is unable to find the cancellation reason in cancellation_reason_id",
  "30013":
    "When the Seller App finds changes in the order object other than the update_target",
  ...
  "40002":
    "When the Seller App is unable to select the specified number in order.items[].quantity",
  "40003":
    "When the quote sent by the Buyer App is no longer available from the Seller App",
  "40004":
    "When the payment object sent by the Buyer App is not supported by the Seller App",
  "40005":
    "When the Seller App does not support tracking for the order in order_id",
  "40006": "When an agent for fulfilment is not available",
  "50000": "Generic Policy Error",
  "50001":
    "When the Seller App is unable to cancel the order due to it's cancellation policy",
  "50002":
    "When the Seller App is unable to update the order due to it's updation policy",
  "50003":
    "When the Seller App receives an entity to rate which is not supported",
  "50004":
    "When the Seller App receives an object if for which it does not provide support",

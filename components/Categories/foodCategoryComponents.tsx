...
import FoodProductResultsWrapper from "../search-comp/FoodProductResultsWrapper";
...
// ✅ Products Section (using new FoodProductResultsWrapper + RestCard)
export const ProductsSection: React.FC<{
  initialProductsData: StoreBucket[];
  selectedAddress: {
    lat: number;
    lng: number;
    pincode: string;
